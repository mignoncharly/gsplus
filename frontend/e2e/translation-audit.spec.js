...
test('English public routes contain no known untranslated interface or legal placeholders', async ({ page }) => {
  ...
  for (const [path, heading] of [['/en/mentions-legales', 'Publisher and intellectual property'], ['/en/confidentialite', 'Data controller and contact'], ['/en/cgv', 'Booking, prices and payment']]) {
  ...
  for (const path of ['/en', '/en/services', '/en/portfolio', '/en/reservation', '/en/services-creatifs', '/en/a-propos', '/en/contact', '/en/corporate', '/en/mentions-legales', '/en/confidentialite', '/en/cgv']) {
