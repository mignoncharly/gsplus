export const PHONE_INVALID_MESSAGE = 'Saisissez un numéro camerounais valide, par exemple 640 70 32 49.';
export const PHONE_WHATSAPP_REQUIRED_MESSAGE = 'Renseignez un téléphone camerounais pour recevoir les informations sur WhatsApp.';
export const EMAIL_INVALID_MESSAGE = 'Saisissez une adresse e-mail valide.';
...
export const validateContactFields = ({
  ...
  if (!trimmedPhone && whatsappConsent) errors.phone = PHONE_WHATSAPP_REQUIRED_MESSAGE;
